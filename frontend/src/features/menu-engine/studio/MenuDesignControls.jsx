...
const labels = {
  en: { presets:"Style presets",original:"Current / Original",originalHint:"Return to the design this menu started with",brand:"Brand",colors:"Colors",typography:"Typography",layout:"Layout",logo:"Logo URL",logoSize:"Logo size",logoShape:"Logo shape",headingFont:"Heading font",bodyFont:"Body font",headingWeight:"Heading weight",itemWeight:"Item weight",text:"Main text",muted:"Secondary text",accent:"Accent",background:"Background",cards:"Cards",category:"Categories",categoryText:"Category text",density:"Density",navigation:"Category navigation",price:"Price position",imagePosition:"Image position",imageRatio:"Image ratio",removeLogo:"Remove logo" },
  he: { presets:"סגנונות מוכנים",original:"נוכחי / מקורי",originalHint:"חזרה לעיצוב שממנו התפריט התחיל",brand:"מותג",colors:"צבעים",typography:"טיפוגרפיה",layout:"פריסה",logo:"כתובת לוגו",logoSize:"גודל לוגו",logoShape:"צורת לוגו",headingFont:"פונט כותרות",bodyFont:"פונט טקסט",headingWeight:"עובי כותרות",itemWeight:"עובי שמות פריטים",text:"טקסט ראשי",muted:"טקסט משני",accent:"צבע מוביל",background:"רקע",cards:"כרטיסים",category:"קטגוריות",categoryText:"טקסט קטגוריות",density:"צפיפות",navigation:"ניווט קטגוריות",price:"מיקום מחיר",imagePosition:"מיקום תמונה",imageRatio:"יחס תמונה",removeLogo:"הסר לוגו" },
  ar: { presets:"أنماط جاهزة",original:"الحالي / الأصلي",originalHint:"العودة إلى التصميم الذي بدأت به القائمة",brand:"العلامة",colors:"الألوان",typography:"الخطوط",layout:"التخطيط",logo:"رابط الشعار",logoSize:"حجم الشعار",logoShape:"شكل الشعار",headingFont:"خط العناوين",bodyFont:"خط النص",headingWeight:"سماكة العناوين",itemWeight:"سماكة أسماء العناصر",text:"النص الرئيسي",muted:"النص الثانوي",accent:"اللون الرئيسي",background:"الخلفية",cards:"البطاقات",category:"الفئات",categoryText:"نص الفئات",density:"الكثافة",navigation:"تنقل الفئات",price:"موضع السعر",imagePosition:"موضع الصورة",imageRatio:"نسبة الصورة",removeLogo:"إزالة الشعار" },
};
...
export default function MenuDesignControls({design,baselineDesign,menu,language="en",panel,setPanel,patchDesign}){
  ...
  return <div className="studio-v3-design-pro-controls">
    <div className="studio-v3-design-section">
      ...
      {original?<button type="button" className={`studio-v3-original-design ${isOriginal?"active":""}`} onClick={()=>patchDesign(()=>original)}><span><strong>{l.original}</strong><small>{l.originalHint}</small></span><span aria-hidden="true">↺</span></button>:null}
    ...
    {panel==="brand"&&<div className="studio-v3-design-section"><label className="studio-v3-design-select"><span>{l.logo}</span><input value={logo} placeholder="https://…" onChange={e=>patchBrand("logoUrl",e.target.value)}/></label><button className="studio-v3-design-remove-logo" type="button" disabled={!logo} onClick={()=>patchBrand("logoUrl","")}>{l.removeLogo}</button><label className="studio-v3-range-field"><span>{l.logoSize} <b>{design.brand.logoSize}px</b></span><input type="range" min="24" max="120" value={design.brand.logoSize} onChange={e=>patchBrand("logoSize",Number(e.target.value))}/></label><SelectField label={l.logoShape} value={design.brand.logoShape} values={["free","rounded","circle","square"]} onChange={value=>patchBrand("logoShape",value)}/></div>}

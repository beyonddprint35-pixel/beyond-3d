...
const COPY = {
  en:{
    ...
    colors:"Themes",typography:"Text style & color",hero:"Top photo & header",density:"Spacing",compact:"Compact",balanced:"Balanced",spacious:"Spacious",logo:"Logo",photo:"Photo",clean:"Clean",templateHero:"Template",heroHint:"Use a dedicated hero photo, your logo, or remove the hero for a clean header.",photoHint:"Hero photos are separate from menu item photos.",uploadHero:"Upload hero image",replaceHero:"Replace hero image",removeHero:"Remove hero image",
    modern:"Modern",elegant:"Elegant",bold:"Bold",editorial:"Editorial",dark:"Dark",playful:"Playful",friendly:"Friendly",
    clickPreview:"Click anything in the live preview to edit it",editing:"Editing",brand:"Brand",categories:"Categories",items:"Menu items",badges:"Badges",colorsPanel:"Themes",typePanel:"Text style & color",layout:"Layout",backQuick:"Back to quick style",

...
export const MENU_COLOR_PRESETS = Object.freeze({
  ...
  bistro: {
    label: "Bistro",
    theme: { background: "#f7f1e8", surface: "#fffaf2", card: "#fffdf8", text: "#241d18", muted: "#7d7066", accent: "#8a3f2d", accentSecondary: "#d7b08b", line: "#eadfd4", categoryBackground: "#8a3f2d", categoryText: "#ffffff" },
  midnight: {
    label: "Midnight",
    theme: { background: "#121722", surface: "#171e2b", card: "#1d2635", text: "#f6f7fb", muted: "#aab3c2", accent: "#d5ad65", accentSecondary: "#485872", line: "#2b3545", categoryBackground: "#d5ad65", categoryText: "#121722" },
  mediterranean: {
    label: "Mediterranean",
    theme: { background: "#f7f4ec", surface: "#fffdf8", card: "#ffffff", text: "#183447", muted: "#71808a", accent: "#2e6d75", accentSecondary: "#d9b77d", line: "#dfe4df", categoryBackground: "#2e6d75", categoryText: "#ffffff" },
  minimal: {
    label: "Minimal",
    theme: { background: "#ffffff", surface: "#ffffff", card: "#ffffff", text: "#111111", muted: "#747474", accent: "#111111", accentSecondary: "#ececec", line: "#e8e8e8", categoryBackground: "#111111", categoryText: "#ffffff" },
  cafe: {
    label: "Café",
    theme: { background: "#f4eee7", surface: "#fffaf5", card: "#fffdf9", text: "#332820", muted: "#84746a", accent: "#795548", accentSecondary: "#c8a985", line: "#e5d8cc", categoryBackground: "#795548", categoryText: "#ffffff" },
});

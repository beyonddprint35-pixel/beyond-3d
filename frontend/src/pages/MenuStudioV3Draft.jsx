...
const UI = {
  en: {
    ...
    itemDraft:"ITEM",editItem:"Edit item",name:"Name",description:"Description",price:"Price",prices:"Prices",currencyHint:"Currency is added automatically",optionLabel:"Price type",addPrice:"Add price type",addAnotherPrice:"Add another price",singlePrice:"Use single price",removePrice:"Remove",priceTypeHint:"Shot, Glass, Bottle, Small, Large…",
    dietary:"Dietary & allergen badges",merchandising:"Highlights & merchandising",ownerConfirmed:"Owner-confirmed only",spiceLevel:"Spice level",notSpicy:"Not spicy",aiSuggestions:"AI badge suggestions",aiNote:"AI may suggest likely badges from the name and description, but the restaurant must confirm them before they appear publicly.",
    cancel:"Cancel",applyDraft:"Done",saving:"Saving…",allSaved:"All changes saved",publish:"Publish",ownerLanguage:"Studio language",contentLanguage:"Menu content language",loading:"Loading your menu…",
    publishTitle:"Publish changes?",publishReady:"Ready to publish",publishBlocked:"Something needs attention",publishNote:"Your saved changes will become visible on your live menu. You can restore an earlier version anytime.",close:"Close",
    analyticsTitle:"Menu performance",analyticsEyebrow:"ANALYTICS · PRIVACY-FIRST",analyticsHint:"This dashboard is ready for real anonymous menu activity. No synthetic numbers are shown.",trackingNotConnected:"Analytics not active yet",trackingNote:"When analytics is enabled, this view will show real behavior from your published menu.",menuViews:"Menu views",categoryViews:"Category views",itemImpressions:"Item impressions",itemOpens:"Item opens",topCategories:"Top categories",topItems:"Top items",engagement:"Engagement",recommendations:"Smart recommendations",noData:"No analytics data yet",noDataHint:"This will start filling automatically when analytics is enabled.",recommendationHint:"Buddy will compare impressions, opens, position and category reach to suggest what to move, feature or mark as Popular / Chef’s Choice.",waitingEvents:"Waiting for real activity",
  },
  he: {
    ...
    itemDraft:"פריט",editItem:"עריכת פריט",name:"שם",description:"תיאור",price:"מחיר",prices:"מחירים",currencyHint:"סמל המטבע מתווסף אוטומטית",optionLabel:"סוג מחיר",addPrice:"הוספת סוג מחיר",addAnotherPrice:"הוספת מחיר נוסף",singlePrice:"מחיר יחיד",removePrice:"הסר",priceTypeHint:"צ׳ייסר, כוס, בקבוק, קטן, גדול…",
    dietary:"תגי תזונה ואלרגנים",merchandising:"הבלטות ושיווק",ownerConfirmed:"באישור בעל העסק בלבד",spiceLevel:"רמת חריפות",notSpicy:"לא חריף",aiSuggestions:"הצעות תגיות AI",aiNote:"ה-AI יכול להציע תגיות לפי שם ותיאור הפריט, אך בעל העסק חייב לאשר אותן לפני שיופיעו לציבור.",
    cancel:"ביטול",applyDraft:"סיום",saving:"שומר…",allSaved:"כל השינויים נשמרו",publish:"פרסום",ownerLanguage:"שפת הסטודיו",contentLanguage:"שפת תוכן התפריט",loading:"טוען את התפריט שלכם…",
    publishTitle:"לפרסם את השינויים?",publishReady:"מוכן לפרסום",publishBlocked:"יש משהו שדורש תשומת לב",publishNote:"השינויים השמורים יהפכו לגלויים בתפריט החי. ניתן לשחזר גרסה קודמת בכל עת.",close:"סגור",
    analyticsTitle:"ביצועי התפריט",analyticsEyebrow:"אנליטיקה · פרטיות תחילה",analyticsHint:"הדשבורד מוכן לפעילות אמיתית ואנונימית מהתפריט. לא מוצגים נתונים מלאכותיים.",trackingNotConnected:"האנליטיקה עדיין לא פעילה",trackingNote:"לאחר הפעלת האנליטיקה, המסך יציג שימוש אמיתי בתפריט שפורסם.",menuViews:"צפיות בתפריט",categoryViews:"צפיות בקטגוריות",itemImpressions:"חשיפות לפריטים",itemOpens:"פתיחת פריטים",topCategories:"קטגוריות מובילות",topItems:"פריטים מובילים",engagement:"מעורבות",recommendations:"המלצות חכמות",noData:"אין עדיין נתוני אנליטיקה",noDataHint:"הנתונים יתחילו להתמלא אוטומטית לאחר הפעלת האנליטיקה.",recommendationHint:"Buddy ישווה חשיפות, פתיחות, מיקום והגעה לקטגוריה ויציע מה לקדם, להזיז או לסמן כפופולרי / בחירת השף.",waitingEvents:"ממתין לפעילות אמיתית",
  },
  ar: {
    ...
    itemDraft:"عنصر",editItem:"تعديل العنصر",name:"الاسم",description:"الوصف",price:"السعر",prices:"الأسعار",currencyHint:"تتم إضافة رمز العملة تلقائيًا",optionLabel:"نوع السعر",addPrice:"إضافة نوع سعر",addAnotherPrice:"إضافة سعر آخر",singlePrice:"سعر واحد",removePrice:"إزالة",priceTypeHint:"جرعة، كأس، زجاجة، صغير، كبير…",
    dietary:"شارات الحمية والحساسية",merchandising:"إبراز وتسويق العناصر",ownerConfirmed:"بتأكيد صاحب المطعم فقط",spiceLevel:"درجة الحدة",notSpicy:"غير حار",aiSuggestions:"اقتراحات شارات بالذكاء الاصطناعي",aiNote:"يمكن للذكاء الاصطناعي اقتراح شارات اعتمادًا على الاسم والوصف، لكن يجب على المطعم تأكيدها قبل ظهورها للعامة.",
    cancel:"إلغاء",applyDraft:"تم",saving:"جارٍ الحفظ…",allSaved:"تم حفظ جميع التغييرات",publish:"نشر",ownerLanguage:"لغة الاستوديو",contentLanguage:"لغة محتوى القائمة",loading:"جارٍ تحميل قائمتك…",
    publishTitle:"نشر التغييرات؟",publishReady:"جاهز للنشر",publishBlocked:"هناك شيء يحتاج إلى الانتباه",publishNote:"ستصبح التغييرات المحفوظة ظاهرة في القائمة المباشرة. يمكنك استعادة إصدار سابق في أي وقت.",close:"إغلاق",
    analyticsTitle:"أداء القائمة",analyticsEyebrow:"التحليلات · الخصوصية أولًا",analyticsHint:"لوحة التحليلات جاهزة لنشاط حقيقي ومجهول الهوية. لا نعرض أرقامًا مصطنعة.",trackingNotConnected:"التحليلات غير مفعلة بعد",trackingNote:"بعد تفعيل التحليلات ستعرض هذه الصفحة الاستخدام الحقيقي للقائمة المنشورة.",menuViews:"مشاهدات القائمة",categoryViews:"مشاهدات الفئات",itemImpressions:"ظهور العناصر",itemOpens:"فتح العناصر",topCategories:"أفضل الفئات",topItems:"أفضل العناصر",engagement:"التفاعل",recommendations:"توصيات ذكية",noData:"لا توجد بيانات تحليلات بعد",noDataHint:"ستبدأ البيانات بالظهور تلقائيًا بعد تفعيل التحليلات.",recommendationHint:"سيحلل Buddy الظهور والفتح والموقع والوصول للفئات ليقترح ما يجب تقديمه أو نقله أو تمييزه كشائع / اختيار الشيف.",waitingEvents:"بانتظار نشاط حقيقي",
  },
};
...
function textFor(value, language) { return value?.[language] || value?.en || value?.he || value?.ar || ""; }
function cleanPrice(value) { return String(value ?? "").replace(/₪/g, "").replace(/\b(?:ILS|NIS)\b/gi, "").trim(); }
function displayPrice(value, currencySymbol=CURRENCY_SYMBOL) { const clean=cleanPrice(value); return clean?`${currencySymbol}${clean}`:""; }
function priceText(item,currencySymbol=CURRENCY_SYMBOL) { return item.price_options?.length?item.price_options.map(option=>displayPrice(option.price,currencySymbol)).filter(Boolean).join(" / "):displayPrice(item.price,currencySymbol); }
function draftId(prefix) { return `${prefix}-${Date.now()}-${Math.random().toString(36).slice(2,8)}`; }
function emptyLanguageText(language,value="") { return {en:"",he:"",ar:"",[language]:value}; }

function flattenGroupTree(groups=[]) {
  const map=new Map(groups.map(group=>[group.id,group]));
  const children=new Map();
  groups.forEach(group=>{ const parent=group.parent_id&&map.has(group.parent_id)?group.parent_id:null; if(!children.has(parent))children.set(parent,[]); children.get(parent).push(group); });
  children.forEach(rows=>rows.sort((a,b)=>Number(a.sort_order||0)-Number(b.sort_order||0)));
  const rows=[]; const seen=new Set();
  function visit(group,depth){ if(!group||seen.has(group.id))return; seen.add(group.id); rows.push({group,depth}); (children.get(group.id)||[]).forEach(child=>visit(child,depth+1)); }
  (children.get(null)||[]).forEach(group=>visit(group,0));
  groups.forEach(group=>{if(!seen.has(group.id))visit(group,0);});
  return rows;
}

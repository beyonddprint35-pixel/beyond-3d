...
export default function DigitalMenuTemplate({
  ...
  useEffect(() => {
    ...
    menu?.requested_languages,
    menu?.detected_language,
  ]);
  ...
  const style = {
    ...
    "--dmt-heading-font":
      `"${branding.heading_font}", "Noto Sans Hebrew", "Noto Sans Arabic", Georgia, serif`,

    "--dmt-body-font":
      `"${branding.body_font}", "Noto Sans Hebrew", "Noto Sans Arabic", Arial, sans-serif`,

    "--dmt-brand-size":
      `${branding.brand_font_size}px`,

    "--dmt-hero-size":
      `${branding.hero_font_size}px`,

    "--dmt-section-size":
      `${branding.section_font_size}px`,

    "--dmt-category-size":
      `${branding.category_font_size}px`,

    "--dmt-item-size":
      `${branding.item_name_font_size}px`,

    "--dmt-description-size":
      `${branding.description_font_size}px`,

    "--dmt-price-size":
      `${branding.price_font_size}px`,

    "--dmt-secondary-size":
      `${branding.secondary_font_size}px`,
  };
  ...
  return (
    ...
    >
      <MenuAccessibility
        ...
        /*
          Live menu:
          same persistent El Puerto behavior.

          Builder:
          isolated so brand colors remain visible.
        */
        persistPreferences={
          !embedded
        }
      ...
      >
        ...
        <section className="dmt-hero">
          ...
          {displayLogo && (
            <div
              className={`dmt-hero-logo dmt-hero-logo-${logoShape}`}
            >
              <img
                src={
                  displayLogo
              ...
              {(
                ...
                (
                  ...
                  return (
                    <article
                      key={`${name}-${itemIndex}`}
                      className="dmt-item-row item-row"
                    >
                      ...
                      <div className="dmt-price-area">
                        ...
                        {options.map(
                          (
                            ...
                            return (
                              <div
                                className="dmt-price-option"
                                key={`${option.price}-${optionIndex}`}
                              >
                                {editable ? (
                                  <EditableText
                                    value={

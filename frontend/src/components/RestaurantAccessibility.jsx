...
const COPY = {
  ...
  ar: {
    ...
    closing:"نواصل العمل على تحسين سهولة الاستخدام وإمكانية الوصول.", enabled:"مفعّل", disabled:"معطّل", max:"حجم النص في الحد الأقصى", normal:"عاد حجم النص للوضع الطبيعي", increased:"تم تكبير النص", decreased:"تم تصغير النص", resetDone:"تمت إعادة ضبط إعدادات إمكانية الوصول"
  }
};

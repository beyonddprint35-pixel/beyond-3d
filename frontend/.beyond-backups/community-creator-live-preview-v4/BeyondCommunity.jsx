...
// BEYOND_COMMUNITY_CARD_PREVIEW_AND_AI_3D_V3
...
function CommunityAiViewer({ item }) {
  const modelUrl = communityAiModelUrl(item);
        ...
        >
          <div className="community-viewer-modal">
            ...
            {viewerItem.source_type === "ai_model" ? (
              <CommunityAiViewer item={viewerItem} />
            ) : (
            ...
            <div className="community-viewer-footer">
              {viewerItem.source_type === "ai_model" ? (
                <>
                  <div>
                    <strong>
                      Want to use this AI creation?
                    </strong>

                    <span>
                      Send it into your BEYOND project flow while the Community original stays unchanged.
                    </span>
                  </div>
